...
rate endpoints, its state, its function, and a first sign of its dynamics --- while the amplification
scalar is null throughout, exactly as the margin-first reframe predicts. Three honest qualifications
define the result.
