...
- Update the relevant [`docs/wiki/`](docs/wiki/Home.md) page in the same PR as any
  ...
  current.
- Figures are regenerated by their scripts (`examples/wiki_figures.jl`,
  `validation_forest_plot.jl`, `salmon_migration_figure.jl`, `salmon_migration_map.jl`) —
  edit the script, not the images.
